...
export function SectionForms() {
    ...
    return (
        <section id="personalizada" className="w-full bg-[#0F1F3D] border-t border-[rgba(37,99,235,0.15)] py-14 md:py-20 lg:py-28 scroll-mt-20">
            <div className="container">
                ...
                <div className="max-w-4xl mx-auto">
                    <Tabs defaultValue="direct" className="w-full">
                        <TabsList className="grid w-full grid-cols-2 mb-8 p-1 h-auto bg-[#1A2B4F] rounded-2xl border border-[rgba(37,99,235,0.15)]">
                            <TabsTrigger
                                value="direct"
                                className="py-3 sm:py-4 rounded-xl text-sm sm:text-base font-medium data-[state=active]:bg-gradient-to-br data-[state=active]:from-[#2563EB] data-[state=active]:to-[#1D4ED8] data-[state=active]:text-white data-[state=active]:shadow-[0_4px_24px_rgba(37,99,235,0.5)] data-[state=active]:hover:shadow-[0_0_30px_rgba(37,99,235,0.7)] transition-all text-[#E5E7EB]"
                            >
